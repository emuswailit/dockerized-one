...
const DrugClasses = (props) => {
  ...
  const [bodySystems, setBodySystems] = React.useState(props.bodysystems);
                  ...
                  <DialogContent>
                    ...
                    <Formik
                      ...
                      validationSchema={Yup.object().shape({
                        ...
                        system: Yup.string().required("Select body sytem"),
                      })}
                    >
                      {(props) => {
                        const {
                  ...
                  <DialogContent>
                    ...
                    <Formik
                      initialValues={{
                        ...
                        system: selectedDrugClass.system,
                      }}
                      onSubmit={(values, { setSubmitting }) => {
                        console.log("at submit for edit", values);
                        props.changeDrugClass(values, selectedDrugClass.id);
                      }}
                      validationSchema={Yup.object().shape({
                        title: Yup.string().required("Title is required"),
                        description: Yup.string().required(
                          ...
                          <form onSubmit={handleSubmit}>
                            <div>
                              ...
                              <Autocomplete
                                ...
                                margin="normal"
                                defaultValue={{
                                  title: selectedDrugClass.system_details.title,
                                  id: values.system,
                                }}
                                id="body-system-select"
                                options={bodySystems}
                                onChange={(e, value) =>
                                  handleAutoCompleteValues(setFieldValue, value)
                                }

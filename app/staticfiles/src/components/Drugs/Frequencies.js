...
const Frequencies = (props) => {
  ...
  //Create new frequencies state
  const [selectedFrequency, setSelectedFrequency] = useState({});
  const [editingFrequency, setEditingFrequency] = useState(false);
  const [creatingFrequency, setCreatingFrequency] = useState(false);
  ...
  useEffect(() => {
    ...
    setCreatingFrequency(false);
  }, [props.update]);

  useEffect(() => {
    setRows(props.frequencies);
  }, [props.frequencies]);
  ...
  const handleDeleteUser = (user_id) => {
    console.log(user_id);
    props.deleteFrequency(user_id);
  };

  //Delete frequencies

  const handleEditFrequency = (bodysystem) => {
    console.log("Edit system", bodysystem);
    setEditingFrequency(true);
    setSelectedFrequency(bodysystem);
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          <Fragment>
            {/* 1. Create frequencies dialog */}

            <Dialog
              open={creatingFrequency}
              onClose={handleClose}
                    ...
                    <Formik
                      ...
                      validationSchema={Yup.object().shape({
                        ...
                        latin: Yup.string().required(
                          "Latin synonym is required"
                        ),
                        numerical: Yup.number().required(
                          "Enter numerical representation"
                        ),
                          ...
                          <form onSubmit={handleSubmit}>
                            <div>
                              ...
                              <TextField
                                ...
                                fullWidth
                                margin="normal"
                                error={errors.latin && touched.latin}
                                label="Latin:"
                                name="latin"
                                type="text"
                                className={classes.textField}
                                ...
                                onBlur={handleBlur}
                                helperText={
                                  errors.latin && touched.latin && errors.latin
                                }
                              />
                              <TextField
                                variant="outlined"
                              ...
                              <TextField
                                ...
                                fullWidth
                                margin="normal"
                                error={errors.numerical && touched.numerical}
                                label="Numeric Representation:"
                                name="numerical"
                                type="number"
                                className={classes.textField}
                  ...
                  <DialogContent>
                    ...
                    <Formik
                      initialValues={{
                        ...
                        latin: selectedFrequency.latin,
                        abbreviation: selectedFrequency.abbreviation,
                        description: selectedFrequency.description,
                        numerical: selectedFrequency.numerical,
                      }}
                      onSubmit={(values, { setSubmitting }) => {
                        setOpenErrorSnackBar(true);

                        console.log("at submit", values);
                        props.changeFrequency(values, selectedFrequency.id);
                      }}
                      validationSchema={Yup.object().shape({
                        title: Yup.string().required("Title is required"),
                        latin: Yup.string().required(
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .filter(
                  (row) =>
                    ...
                    row.latin.includes(search) ||
                    row.abbreviation.includes(search)
                )
                .map((row, index) => {
                    ...
                    <TableRow hover>
                      ...
                      <TableCell>
                        ...
                        <IconButton
                          ...
                          size="small"
                          color="primary"
                          onClick={() => handleEditFrequency(row)}
                        >
                          <EditIcon />
                        </IconButton>
                      </TableCell>
...
const mapStateToProps = (state) => {
  return {
    ...
    update: state.frequencies.update,
  };
};

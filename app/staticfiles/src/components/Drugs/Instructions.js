...
const Instructions = (props) => {
  ...
  const handleDeleteUser = (user_id) => {
    console.log(user_id);
    props.deleteInstruction(user_id);
  };

  //Delete instruction

  const handleEditInstruction = (bodysystem) => {
    console.log("Edit system", bodysystem);
    setEditingInstruction(true);
    setSelectedInstruction(bodysystem);
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          <Fragment>
            {/* 1. Create instruction dialog */}
            <Dialog
              open={creatingInstruction}
              onClose={handleClose}
              aria-labelledby="form-dialog-title"
            >
              {!props.submissionSuccessful && creatingInstruction && (
                <React.Fragment>
                  ...
                  <DialogContent>
                    ...
                    <Formik
                      ...
                      onSubmit={(values, { setSubmitting }) => {
                        ...
                        props.changeInstruction(values, selectedInstruction.id);
                      }}
                      validationSchema={Yup.object().shape({
                        title: Yup.string().required("Title is required"),
                        description: Yup.string().required(
...
const mapStateToProps = (state) => {
  return {
    ...
    update: state.instructions.update,
  };
};
